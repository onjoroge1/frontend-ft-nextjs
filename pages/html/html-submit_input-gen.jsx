...
export default function HtmlSubmitInput() {
  ...
  let tag = '';
  tag += ` <input type="${'submit'}" value="${type}" ${focus} ${disable}  />`;
      ...
      <div className='detail-hero'>
        ...
        <div className='detail-hero-content'>
          <div className='detail-hero-content-heading'>
            <h1>HTML Submit Input Generator</h1>
          </div>
          <div className='detail-hero-content-des'>
            <p>
              Generate HTML Submit Input with our generator tool. Preview the
