...
export default function HtmlPasswordInput() {
  ...
  let tag = '';
  tag += `   <input type="${'password'}" ${required}  placeholder="${value}"  />`;
      ...
      <div className='detail-hero'>
        ...
        <div className='detail-hero-content'>
          <div className='detail-hero-content-heading'>
            <h1>HTML Password Input Generator</h1>
          </div>
          <div className='detail-hero-content-des'>
            <p>
              Generate HTML Password Input with our generator tool. Preview the
