...
export default function JsonToYaml() {
  ...
  useEffect(() => {
    document.title = 'JSON To YAML Generator';
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/jsontoyaml`, data)
      .then((response) => {
      ...
      >
        ...
        <div className='detail-hero-content'>
          <div className='detail-hero-content-heading'>
            <h1>JSON To YAML Generator</h1>
          </div>
          <div className='detail-hero-content-des'>
            <p>
              Generate JSON To YAML with our generator tool. Preview the result
